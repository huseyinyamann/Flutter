import 'package:exercise_2/101/image_learn.dart';
      ...
      body: Padding(
        ...
        child: Column(children: [
          ...
          Padding(
            ...
            child: _SubtTitleWidget(title: _description *10,),
          ),
          const Spacer(), // colum icinde spcer atarsan o tum boslugu alir sadece sana ihtiyacin olan kadar verir

          _createButton(context),

           TextButton(onPressed: (){}, child: Text(_importNote, style: 
           Theme.of(context).textTheme.bodyLarge?.copyWith(
            color: Colors.blue
           ),),
        ),  SizedBox(ButtonHeights.buttonNormalHeight,)],),
      ),
    );
  }

  ElevatedButton _createButton(BuildContext context) {
    return ElevatedButton(onPressed: (){}, child: SizedBox(height:
         ButtonHeights.buttonNormalHeight,child: Center(child:
         Text(_createNote, style: Theme.of(context).textTheme.headlineSmall,)
         ),
         ),
...
final String title;
  @override
  Widget build(BuildContext context) {
    return Text(title,textAlign: textAlign, style: Theme.of(context).textTheme.bodyLarge?.copyWith(color: Colors.black, fontWeight: FontWeight.w500,),);
  }
}
